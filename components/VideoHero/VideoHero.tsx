...
function VideoHero() {
  return (
      <>
    {/* Desktop only */}
    <div className='block w-full min-h-[500px] overflow-hidden relative'>
        <video autoPlay muted loop playsInline id="HeroVideo" className='absolute top-0 left-0 object-cover w-full h-full'>
        ...
        <div className="absolute top-0 right-0 left-0 bottom-0 flex flex-row items-center">
            <div className="mx-auto w-7xl min-w-7xl max-w-7xl p-6 lg:px-8 flex-1 flex flex-col gap-8">
                <h1 className='font-regular text-4xl'><span className='font-bold text-blue-500'>Airsoft HQ</span> - Dein Zuhause</h1>
    ...
    {/* Mobile only */}
    {/* <div className='block lg:hidden w-full h-auto md:max-h-[500px] overflow-hidden relative'>
